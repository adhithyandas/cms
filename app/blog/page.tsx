      ...
      <section className="relative py-20 overflow-hidden min-h-[30vh] flex items-center">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto font-normal leading-relaxed">
            Explore insights, tutorials, industry trends, and expert perspectives from the Zeruqua
            Labs team.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {posts.map((post, i) => (
              <Link
                href="#"
                key={post._id || i}
                className="bg-[#111] rounded-2xl overflow-hidden border border-white/5 group flex flex-col cursor-pointer"
              >
