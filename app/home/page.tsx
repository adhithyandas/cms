  ...
  return (
    <div className="bg-[#0a0a0a] min-h-screen text-white font-sans selection:bg-red-500/30 w-full overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
            <div className="lg:w-1/2 space-y-8">
              ...
              <p className="text-lg text-gray-400 max-w-xl font-normal leading-relaxed">
                DevSphere Academy provides world-class tech education and hands-on training to help you build a successful career in tech.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button size="lg" className="bg-red-600 hover:bg-red-700 text-white rounded-md px-8 text-base h-12 border-0">
                  Explore Courses &rarr;
                </Button>
                <Button size="lg" variant="outline" className="rounded-md px-8 text-base h-12 text-white border-white/20 bg-transparent hover:bg-white/5">
                  Contact Us
                </Button>
              </div>
            </div>
            ...
            <div className="lg:w-1/2 relative flex justify-center lg:justify-end">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                ...
                <div className="w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] rounded-full border border-red-500/20 absolute animate-pulse" style={{ animationDelay: '1s' }}></div>
                <div className="w-[400px] h-[400px] sm:w-[500px] sm:h-[500px] rounded-full border border-red-500/10 absolute animate-pulse" style={{ animationDelay: '2s' }}></div>
                <div className="w-[500px] h-[500px] sm:w-[600px] sm:h-[600px] rounded-full border border-red-500/5 absolute animate-pulse" style={{ animationDelay: '3s' }}></div>
                ...
                <div className="absolute top-[15%] right-[25%] w-2 h-2 bg-red-400 rounded-full shadow-[0_0_10px_rgba(248,113,113,0.9)] animate-bounce" style={{ animationDelay: '0.5s' }}></div>
                <div className="absolute bottom-[20%] left-[15%] w-3 h-3 bg-red-600 rounded-full shadow-[0_0_15px_rgba(220,38,38,0.7)] animate-pulse" style={{ animationDelay: '1.5s' }}></div>
                <div className="absolute top-[65%] left-[5%] w-2 h-2 bg-red-500 rounded-full opacity-80 animate-ping" style={{ animationDelay: '2s' }}></div>
                <div className="absolute top-[80%] right-[15%] w-1.5 h-1.5 bg-white rounded-full opacity-50 animate-pulse" style={{ animationDelay: '0.8s' }}></div>
                <div className="absolute top-[30%] left-[10%] w-2.5 h-2.5 bg-red-500 rounded-full shadow-[0_0_10px_rgba(239,68,68,0.8)] animate-bounce" style={{ animationDelay: '1.2s' }}></div>
              </div>
              <Image
          ...
          <div className="bg-[#111] border border-white/5 rounded-2xl p-8 md:p-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x-0 md:divide-x divide-white/10">
              {stats.map((stat, index) => (
                <div key={index} className="flex flex-col items-center justify-center text-center space-y-1">
                  {stat.icon}
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-4">
            ...
            <Link href="#" className="text-red-500 text-sm font-medium hover:text-red-400 transition-colors flex items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5">
            {courses.map((course, index) => (
              <Card key={index} className="bg-[#111] border border-white/5 shadow-none hover:border-red-500/30 transition-colors h-full flex flex-col">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-[#111] rounded-2xl overflow-hidden border border-white/5 hover:border-red-500/30 transition-all hover:-translate-y-1 group flex flex-col">
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">Take a glimpse into our vibrant community, workshops, and events.</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            <div className="col-span-2 row-span-2 rounded-2xl aspect-square md:aspect-auto relative overflow-hidden group">
              ...
              <Image src="https://images.unsplash.com/photo-1540575467063-178a50c2df87?auto=format&fit=crop&w=800&q=80" alt="Gallery" fill className="object-cover group-hover:scale-105 transition-transform duration-700" />
            ...
            <div className="rounded-2xl aspect-square relative overflow-hidden group">
              ...
              <Image src="https://images.unsplash.com/photo-1515187029135-18ee286d815b?auto=format&fit=crop&w=400&q=80" alt="Gallery" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
            </div>

            <div className="rounded-2xl aspect-square relative overflow-hidden group">
              <div className="absolute inset-0 bg-black/40 group-hover:bg-black/10 transition-colors z-10" />
              <Image src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=400&q=80" alt="Gallery" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
            </div>

            <div className="rounded-2xl aspect-square relative overflow-hidden group">
              <div className="absolute inset-0 bg-black/40 group-hover:bg-black/10 transition-colors z-10" />
              <Image src="https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&w=400&q=80" alt="Gallery" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
            </div>

            <div className="rounded-2xl aspect-square relative overflow-hidden group">
              <div className="absolute inset-0 bg-black/40 group-hover:bg-black/10 transition-colors z-10" />
              <Image src="https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=400&q=80" alt="Gallery" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="bg-gradient-to-r from-[#1f0a0a] to-[#2a0b0b] border border-red-900/40 rounded-2xl p-10 md:p-14 flex flex-col md:flex-row items-center justify-between text-left shadow-2xl shadow-red-900/10">
            ...
            <Button size="lg" className="bg-red-600 hover:bg-red-700 text-white rounded-md px-10 text-base font-semibold h-14 shadow-lg shadow-red-900/20 whitespace-nowrap border-0">
              Get Started Now
            </Button>
          </div>
        </div>
      ...
      <section className="py-16 mt-8">
        <div className="container mx-auto px-4 lg:px-8">
          <h3 className="text-center text-sm font-medium text-gray-400 mb-12">Trusted by Top Companies</h3>
